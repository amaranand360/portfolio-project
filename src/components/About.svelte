...
>
  ...
  >
    ...
    >
      A full-stack developer, having a strong understanding of  Node.js and React.js web 
      development.I'm passionate about crafting efficient and high-quality solutions for clients.
       With a commitment to staying current with the latest technologies. I approach each project with humility and dedication, always eager to learn and grow as a
      developer
  </div>
